# Lab 3: Copilot Cowork: Transforming Weak Prompts into GCSE-Aligned Prompts

**Lab duration- 30 minutes**

### **Lab Overview**

This hands-on lab walks through three common Cowork task types ---
meeting prep, inbox triage, and performance forecasting. For each task
type, you\'ll run a deliberately weak, Goal-only prompt first, observe
its shortcomings, then rewrite the same request using the **GCSE
framework** (Goal, Context, Source, Expectation) and compare the two
outputs side by side. Each section ends with a review checklist so you
can verify the strong prompt actually produced a review-ready
deliverable rather than generic output. By the end, you\'ll have a
repeatable framework to apply to your own Cowork tasks going forward.
...
4.  **Specify concrete expectations** --- format, structure, length, and
    required actions --- to produce outputs that are immediately usable
    (a brief, drafted replies, a report).
...
- No prior prompt-engineering experience required --- the lab teaches
  the GCSE framework from scratch
...
1.  Log in to +++https://copilot.microsoft.com/+++ with your lab
    credentials.\
    ![](./Lab_3_media/media/image.png){width="5.322916666666667in"
    height="4.145833333333333in"}

2.  Enter your password.\
    ![](./Lab_3_media/media/image2.png){width="5.125in"
    height="3.9791666666666665in"}

3.  Select Cowork tab.\
    ![](./Lab_3_media/media/image3.png){width="6.25in"
    height="2.4375in"}

4.  In the chat box, paste the following prompt:\
    "Help me get ready for my Contoso meeting."\
    ![](./Lab_3_media/media/image4.png){width="6.25in"
    height="3.28125in"}

5.  Run this in Cowork now, then review the response:\
    ![](./Lab_3_media/media/image5.png){width="6.25in"
    height="3.53125in"}
...
![](./Lab_3_media/media/image6.png){width="5.616147200349956in"
height="3.1770833333333335in"}

2.  Review the output:

![](./Lab_3_media/media/image7.png){width="5.551765091863517in"
height="3.78125in"}

**[Element , In this prompt]{.underline}**
...
"Sort out my inbox."\
![](./Lab_3_media/media/image8.png){width="4.662382983377078in"
height="3.1979166666666665in"}

2.  Run this in Cowork now, then review the response:\
    ![](./Lab_3_media/media/image9.png){width="5.239312117235346in"
...
- No review step --- it might send or delete without you seeing it
  first.
...
concise tone."\
![](./Lab_3_media/media/imagea.png){width="4.53125in"
height="4.117338145231846in"}

2.  Approve the email. Select Approve All to approve all the emails.\
    ![](./Lab_3_media/media/imageb.png){width="6.25in"
    height="5.729166666666667in"}

3.  Review the response:

![](./Lab_3_media/media/imagec.png){width="6.5in" height="5.90625in"}
...
![](./Lab_3_media/media/imaged.png){width="6.5in" height="2.21875in"}

2.  Run this in Cowork now, then review the response:\
    ![](./Lab_3_media/media/imagee.png){width="6.25in" height="5.625in"}
...
![](./Lab_3_media/media/imagef.png){width="6.5in" height="5.90625in"}

2.  Review the prompt:\
    ![](./Lab_3_media/media/image10.png){width="6.25in"
    height="5.729166666666667in"}
...
[Note]{.underline}: Run the strong prompt in Cowork, then check the
response against this list:
...
- Context --- Have I given the situation, audience, tone, and
  constraints?

- Source --- Have I told Cowork exactly where to get the material?

- Expectation --- Have I specified the format, structure, length, and
  the action to take?
