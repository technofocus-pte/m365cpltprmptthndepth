...
1.  Log in to +++https://copilot.microsoft.com/+++ with your lab
    credentials.\
    ![](./Lab_2_media/media/image.png){width="5.322916666666667in"
    height="4.145833333333333in"}

2.  Enter your password.\
    ![](./Lab_2_media/media/image2.png){width="5.125in"
    height="3.9791666666666665in"}

3.  In the left navigation pane, find Agents, then select New agent.\
    ![](./Lab_2_media/media/image3.png){width="6.25in"
...
4.  You can view that there is configure and Describe sections that
    ...
    ![](./Lab_2_media/media/image4.png){width="6.25in"
...
1.  Go to the Agent you recently created. Select the hamburger icon.
    Select Edit.\
    ![](./Lab_2_media/media/imaged.png){width="4.552083333333333in"
    height="6.25in"}

2.  On the Configure tab, paste the Name to:

+++Study Buddy+++\
![](./Lab_2_media/media/imagee.png){width="6.5in"
...
3.  Paste the Description to a short, precise summary --- this helps the
    ...
    ![](./Lab_2_media/media/imagef.png){width="5.354166666666667in"
...
> ![](./Lab_2_media/media/image10.png){width="6.5in" height="5.875in"}

5.  Select Update.\
    ![](./Lab_2_media/media/image11.png){width="6.25in" height="1.25in"}

6.  Go to the Try it tab and enter the same user prompt as before:

+++Explain how the internet works.+++\
![](./Lab_2_media/media/image12.png){width="6.5in"
height="2.0104166666666665in"}

7.  Review the output:\
    ![](./Lab_2_media/media/image13.png){width="6.25in"
    height="4.1875in"}

8.  Test the scope rule. Ask something off-topic, such as:

+++Write me a business email to my landlord.+++\
![](./Lab_2_media/media/image14.png){width="6.5in"
height="1.3333333333333333in"}

9.  Review the output:\
    ![](./Lab_2_media/media/image15.png){width="6.25in"
...
![](./Lab_2_media/media/image16.png){width="6.5in"
...
![](./Lab_2_media/media/image17.png){width="6.5in"
...
3.  Confirm the new answer copies the example\'s shape: short summary, a
    ...
    ![](./Lab_2_media/media/image18.png){width="6.854166666666667in"
    height="4.625in"}
...
1.  Go to the **Configure** tab.\
    ![](./Lab_2_media/media/image19.png){width="6.25in"
...
![](./Lab_2_media/media/image1a.png){width="6.291666666666667in"
height="6.5in"}
...
1.  Select the AI model as Quick Summary.\
    ![](./Lab_2_media/media/image1b.png){width="6.25in"
...
2.  Navigate to the agent. In the description box, paste the following
    ...
    ![](./Lab_2_media/media/image1c.png){width="6.25in"
    height="2.8541666666666665in"}

3.  Review the output:\
    ![](./Lab_2_media/media/image1d.png){width="6.25in"
    height="3.71875in"}

4.  Click +New Chat. Select the AI model as Think Deeper.\
    ![](./Lab_2_media/media/image1e.png){width="6.25in"
    height="2.4895833333333335in"}

5.  Paste the same prompt as above:\
    +++Explain how vaccines work to someone with no science background,
    using a simple analogy.+++\
    ![](./Lab_2_media/media/image1f.png){width="6.25in"
    height="3.0104166666666665in"}

6.  Review the output:\
    ![](./Lab_2_media/media/image20.png){width="6.25in"
    height="4.166666666666667in"}
